                ...
                <ul class="swiper-wrapper p-0 m-0">
                    <li class="swiper-slide slide-item">
                        <div class="block-images position-relative">
                            <div class="img-box">
                                <img src="<?=ASSETS?>images/video/03.jpg" class="img-fluid" loading="lazy" alt="">
                            </div>
                    ...
                    <li class="swiper-slide slide-item">
                        <div class="block-images position-relative">
                            <div class="img-box">
                                <img src="<?=ASSETS?>images/video/04.jpg" class="img-fluid" loading="lazy" alt="">
                            </div>
                            <div class="block-description">
                    ...
                    <li class="swiper-slide slide-item">
                        <div class="block-images position-relative ">
                            <div class="img-box">
                                <img src="<?=ASSETS?>images/video/01.jpg" class="img-fluid" loading="lazy" alt="">
                            </div>
                            <div class="block-description">
                    ...
                    <li class="swiper-slide slide-item">
                        <div class="block-images position-relative ">
                            <div class="img-box">
                                <img src="<?=ASSETS?>images/video/02.jpg" loading="lazy" class="img-fluid" alt="">
                            </div>
                            <div class="block-description">
                    ...
                    <li class="swiper-slide slide-item">
                        <div class="block-images position-relative">
                            <div class="img-box">
                                <img src="<?=ASSETS?>images/video/05.jpg" loading="lazy" class="img-fluid" alt="">
                            </div>
                            <div class="block-description">
                    ...
                    <li class="swiper-slide slide-item">
                        <div class="block-images position-relative ">
                            <div class="img-box">
                                <img src="<?=ASSETS?>images/video/10.jpg" loading="lazy" class="img-fluid" alt="">
                            </div>
                            <div class="block-description">
                                <h6 class="iq-title"><a href="show-detail.html">Shadow Warrior</a></h6>
                                <div class="movie-time d-flex align-items-center my-2">
                    ...
                    <li class="swiper-slide slide-item">
                        <div class="block-images position-relative ">
                            <div class="img-box">
                                <img src="<?=ASSETS?>images/video/06.jpg" loading="lazy" class="img-fluid" alt="">
                            </div>
                            <div class="block-description">
                                <h6 class="iq-title"><a href="show-detail.html">Narnia</a></h6>
                                <div class="movie-time d-flex align-items-center my-2">
                    ...
                    <li class="swiper-slide slide-item">
                        <div class="block-images position-relative">
                            <div class="img-box">
                                <img src="<?=ASSETS?>images/video/07.jpg"  loading="lazy" class="img-fluid" alt="">
                            </div>
                            <div class="block-description">
                                <h6 class="iq-title"><a href="show-detail.html">X-Men</a></h6>
                                <div class="movie-time d-flex align-items-center my-2">
                    ...
                    <li class="swiper-slide slide-item">
                        <div class="block-images position-relative">
                            <div class="img-box">
                                <img src="<?=ASSETS?>images/video/08.jpg" loading="lazy" class="img-fluid" alt="">
                            </div>
                            <div class="block-description">
                                <h6 class="iq-title"><a href="show-detail.html">Logan</a></h6>
                                <div class="movie-time d-flex align-items-center my-2">
                    ...
                    <li class="swiper-slide slide-item">
                        <div class="block-images position-relative">
                            <div class="img-box">
                                <img src="<?=ASSETS?>images/video/09.jpg" loading="lazy" class="img-fluid" alt="">
                            </div>
                            <div class="block-description">
                                <h6 class="iq-title"><a href="show-detail.html">Black Queen</a></h6>
                                <div class="movie-time d-flex align-items-center my-2">
